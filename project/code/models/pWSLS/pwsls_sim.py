...
def pwsls_sim(parameters, num_of_trials, transition_prob, reward_probs):
    """
    this funcation simulate an Probabilistic Win-stay-loss-shift agent in the *reduce* two step task 
    Args:
    ...
    p_stay_loss = parameters['p_stay_loss']
