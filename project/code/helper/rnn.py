...
def create_model(n_actions, n_state, n_cells):
    """
    ...
    # policy probablity of taking each action
...
def train_a_model_dataframe(train_data, train_arr,test_data, test_arr, num_of_trials, n_cells, lr, epochs, batch_size, cp_callback):
    """
    ...
    model, sim_model = create_model(n_actions=2, n_state=2, n_cells=n_cells)
...
def train_a_model_csv(path, train_arr, test_arr, num_of_trials, n_cells, lr, epochs, batch_size, cp_callback):
    """
